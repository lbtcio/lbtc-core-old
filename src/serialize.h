...
template<typename Stream> inline void Serialize(Stream& s, uint160 a)  { a.Serialize(s); }
...
template<typename Stream> inline void Unserialize(Stream& s, uint160 a)   { a.Unserialize(s); }
