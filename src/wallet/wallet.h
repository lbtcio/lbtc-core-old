...
public:
    ...
    std::vector<unsigned char> CreateVoteInfo(const CBitcoinAddress& fromAddr, const std::vector<unsigned char>& data);
    /**
    ...
    bool CreateRegisterTransaction(const CRecipient& vecSend, CWalletTx& wtxNew, CReserveKey& reservekey, CAmount& nFeeRet, int& nChangePosInOut,
                               std::string& strFailReason, const CBitcoinAddress& fromAddr, std::vector<unsigned char> data,
                               bool bCollect = true, const CCoinControl *coinControl = NULL, bool sign = true);
