...
bool IsVotingTxout(const CTxOut& txout, CPubKey& pubkey, CScript& script);
...
bool AcceptToMemoryPool(CTxMemPool& pool, CValidationState &state, const CTransactionRef &tx, bool fLimitFree,
                        ...
                        bool fOverrideMempoolLimit=false, const CAmount nAbsurdFee=100000000);
...
bool GetWitnessShare(const CKeyID& id, uint64_t& nShare);
...
extern CVoteDB* pvote;

extern CWitnessDB* pwitness;
